...
test("composer and effort selectors exclude unrelated editable fields and menu buttons", () => {
  ...
  const document = createDocument(`<body><form>
    ...
    <div contenteditable="true" role="textbox" data-composer-markdown id="composer-markdown"></div>
    <div contenteditable="false" role="textbox" data-composer-markdown id="readonly-markdown"></div>
